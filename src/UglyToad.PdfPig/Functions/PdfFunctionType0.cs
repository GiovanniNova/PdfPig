namespace UglyToad.PdfPig.Functions
{
    ...
    internal sealed class PdfFunctionType0 : PdfFunction
    {
        ...
        /// Stitching function
        /// </summary>
        public PdfFunctionType0(DictionaryToken function) : base(function)
        {
        }
        ...
        /// Stitching function
        /// </summary>
        public PdfFunctionType0(StreamToken function) : base(function)
        {
        }
        ...
        private int[][] GetSamples()
        {
            if (samples == null)
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine($"IOException while reading the sample values of this function. {exception}");
