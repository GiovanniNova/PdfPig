namespace UglyToad.PdfPig.Functions
{
    ...
    internal sealed class PdfFunctionType3 : PdfFunction
    {
        ...
        private PdfFunction[] functionsArray;
        private double[] boundsValues;

        /// <summary>
        /// Stitching function
        /// </summary>
        public PdfFunctionType3(DictionaryToken function)
            : base(function)
        {
        }
        ...
        /// Stitching function
        /// </summary>
        public PdfFunctionType3(StreamToken function)
            : base(function)
        {
        }
        ...
        public override double[] Eval(double[] input)
        {
            ...
            {
                ArrayToken ar = Functions;
                functionsArray = new PdfFunction[ar.Length];
                for (int i = 0; i < ar.Length; ++i)
                {
                    functionsArray[i] = PdfFunction.Create(ar[i]);
                }
            }
